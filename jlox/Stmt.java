...
abstract class Stmt {
    ...
    static class Assert extends Stmt {
        Assert(Token operator, Expr expression) {
    ...
    static class Class extends Stmt {
        Class(Token name, Expr.Variable superclass, List<Stmt.Function> methods, List<Stmt.Static> statics, List<Stmt.Function> getters) {
            this.name = name;
